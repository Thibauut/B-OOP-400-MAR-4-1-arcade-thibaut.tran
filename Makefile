...
graphicals:
	g++ -shared -fPIC -o lib/arcade_sfml.so $(SRC_SFML) -lsfml-graphics	-lsfml-audio -lsfml-window -lsfml-system -g3
	g++ -shared -fPIC -o lib/arcade_sdl.so $(SRC_SDL) -lSDL2_image -lSDL2_ttf -lSDL2 -lSDL2main -fno-gnu-unique  -g3
	g++ -shared -fPIC -o lib/arcade_ncurses.so $(SRC_NCURSES) -fno-gnu-unique -lncurses  -g3
